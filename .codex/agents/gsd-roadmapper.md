...
Reference full template: `D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/templates/state.md`.
