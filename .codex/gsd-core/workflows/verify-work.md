...
<template>
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/workflows/transition.md`.
...
- Follow @D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/workflows/diagnose-issues.md
