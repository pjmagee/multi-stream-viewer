...
<required_reading>
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/ai-frameworks.md
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.codex/agents/gsd-eval-planner.md for instructions.
