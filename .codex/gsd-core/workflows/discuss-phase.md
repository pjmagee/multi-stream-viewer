...
<required_reading>
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/domain-probes.md
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/gate-prompts.md
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
