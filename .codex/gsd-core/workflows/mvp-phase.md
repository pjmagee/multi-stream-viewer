...
<required_reading>
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/user-story-template.md
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/spidr-splitting.md
@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/spidr-splitting.md`. Briefly:
