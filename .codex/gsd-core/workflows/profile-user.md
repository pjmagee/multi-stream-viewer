...
Key references:
- @D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/ui-brand.md (display patterns)
- @D:/Projects/pjmagee/multi-stream-viewer/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/USER-PROFILE.md" "D:/Projects/pjmagee/multi-stream-viewer/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/user-profiling.md`
...
Reference: @D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/Projects/pjmagee/multi-stream-viewer/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at D:/Projects/pjmagee/multi-stream-viewer/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/Projects/pjmagee/multi-stream-viewer/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="D:/Projects/pjmagee/multi-stream-viewer/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   D:/Projects/pjmagee/multi-stream-viewer/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        D:/Projects/pjmagee/multi-stream-viewer/.codex/AGENTS.md
```
