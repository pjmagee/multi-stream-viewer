...
```
Agent(
  prompt="Read D:/Projects/pjmagee/multi-stream-viewer/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/templates/SECURITY.md`
