...
<!-- For checkpoint task examples and patterns, see @D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/checkpoints.md -->
...
See `D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/Projects/pjmagee/multi-stream-viewer/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
