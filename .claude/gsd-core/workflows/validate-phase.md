...
```
Agent(
  prompt="Read D:/Projects/pjmagee/multi-stream-viewer/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/VALIDATION.md`
