...
- **Global scope**: `D:/Projects/pjmagee/multi-stream-viewer/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Projects/pjmagee/multi-stream-viewer/.claude/notes/`)
...
2. Glob `D:/Projects/pjmagee/multi-stream-viewer/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/Projects/pjmagee/multi-stream-viewer/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Projects/pjmagee/multi-stream-viewer/.claude/notes/` — works in any directory
