...
<required_reading>
@D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/references/ai-frameworks.md
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.claude/agents/gsd-eval-planner.md for instructions.
