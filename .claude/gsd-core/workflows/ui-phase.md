...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Projects/pjmagee/multi-stream-viewer/.claude/agents/gsd-ui-checker.md for instructions.
