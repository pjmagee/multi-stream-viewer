...
See D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/discovery.md
...
Use D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/discovery.md.
