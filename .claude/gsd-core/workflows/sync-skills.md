...
INSTALL_JS_GLOBAL="D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
