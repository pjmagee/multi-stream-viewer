...
- Usage: Reference from command with `@D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/Projects/pjmagee/multi-stream-viewer/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Projects/pjmagee/multi-stream-viewer/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
