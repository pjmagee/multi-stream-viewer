...
<required_reading>
Read `D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
