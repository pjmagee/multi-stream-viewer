...
<required_reading>
@D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Projects/pjmagee/multi-stream-viewer/.claude
                  → checks D:/Projects/pjmagee/multi-stream-viewer/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core
                  → writes to D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/hooks/
...
@D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/references/common-bug-patterns.md
