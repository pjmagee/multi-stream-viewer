...
Use template from `D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `D:/Projects/pjmagee/multi-stream-viewer/.claude/gsd-core/templates/UI-SPEC.md`
